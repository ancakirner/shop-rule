...
class SourceCategoryController extends Controller
{
    ...
    {        
        ...
        return $this->render('ShopShopRuleBundle:SourceCategory:source_category.html.twig', array(
    ...
    {        
        ...
        return $this->render('ShopShopRuleBundle:SourceCategory:source_category_view.html.twig', array(
    ...
    {
        return $this->getDoctrine()->getRepository('ShopShopRuleBundle:BudgetEntry');
    }
}
